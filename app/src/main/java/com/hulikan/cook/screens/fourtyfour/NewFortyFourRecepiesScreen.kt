...
@Composable
fun NewFortyFourRecepiesScreen(context : Context, navController: NavController){
                        ...
                        modifier = Modifier.size(30.dp).padding(end = 4.dp).clickable {
                            if (titleText.value.isNullOrBlank() && contentText.value.isNullOrBlank()) {
                                ...
                                scope.launch {
                                    ...
                                    db.fortyFourDao().insertFortyFour(FortyFour(title = title, content = content, images = images, videos = ""))
                                    ...
                                    navController.navigate("FortyFourScreen/$encodedTitle/$encodedContent/$encodedImageUri")
                                }
                            }
                        },
