...
@Composable
fun NewTwentyRecepiesScreen(context : Context, navController: NavController){
                        ...
                        modifier = Modifier.size(30.dp).padding(end = 4.dp).clickable {
                            if (titleText.value.isNullOrBlank() && contentText.value.isNullOrBlank()) {
                                ...
                                scope.launch {
                                    ...
                                    db.twentyDao().insertTwenty(Twenty(title = title, content = content, images = images, videos = ""))
                                    ...
                                    navController.navigate("TwentyScreen/$encodedTitle/$encodedContent/$encodedImageUri")
                                }
                            }
                        },
