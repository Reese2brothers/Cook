...
@Composable
fun ThirtyEightEditRecepiesScreen(context: Context, navController: NavController, title: String, content: String, image : String){
                    ...
                    confirmButton = {
                        Button(colors = ButtonDefaults.buttonColors(
                            ...
                            onClick = {
                                scope.launch {
                                    scope.launch {
                                        db.thirtyEightDao().updateRecepie(
                                            titleText.value,
                                            contentText.value,
                                            decodedTitle,
                                            decodedImage
                                    ...
                                    navController.navigate("ThirtyEightRecepiesScreen/$updatedTitle/$updatedContent/$updatedImage")
                                }
                                showDialog.value = false
                            }) {
