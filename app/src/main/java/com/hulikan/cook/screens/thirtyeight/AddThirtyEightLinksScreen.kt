...
@Composable
fun AddThirtyEightLinksScreen(context : Context, navController: NavController){
                    ...
                    .clickable {
                        scope.launch {
                            if (titleText.value.isNotBlank() && linkText.value.isNotBlank()) {
                                db
                                    .thirtyEightLinksDao()
                                    .insertThirtyEightLinks(
                                        ThirtyEightLinks(
                                            title = titleText.value,
                                            link = linkText.value
                                        )
                                    )
                                navController.navigate("ThirtyEightScreen/${titleText.value}/\"no_data\"/\"no_data\"")
                            } else {
                                Toast
                                    .makeText(
                                        context,
