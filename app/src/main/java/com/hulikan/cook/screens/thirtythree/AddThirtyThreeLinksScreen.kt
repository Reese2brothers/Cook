...
@Composable
fun AddThirtyThreeLinksScreen(context : Context, navController: NavController){
                    ...
                    .clickable {
                        scope.launch {
                            if (titleText.value.isNotBlank() && linkText.value.isNotBlank()) {
                                db
                                    .thirtyThreeLinksDao()
                                    .insertThirtyThreeLinks(
                                        ThirtyThreeLinks(
                                            title = titleText.value,
                                            link = linkText.value
                                        )
                                    )
                                navController.navigate("ThirtyThreeScreen/${titleText.value}/\"no_data\"/\"no_data\"")
                            } else {
                                Toast
                                    .makeText(
                                        context,
