...
@Composable
fun NewEighteenRecepiesScreen(context : Context, navController: NavController){
                        ...
                        modifier = Modifier.size(30.dp).padding(end = 4.dp).clickable {
                            if (titleText.value.isNullOrBlank() && contentText.value.isNullOrBlank()) {
                                ...
                                scope.launch {
                                    ...
                                    db.eighteenDao().insertEighteen(Eighteen(title = title, content = content, images = images, videos = ""))
                                    ...
                                    navController.navigate("EighteenScreen/$encodedTitle/$encodedContent/$encodedImageUri")
                                }
                            }
                        },
