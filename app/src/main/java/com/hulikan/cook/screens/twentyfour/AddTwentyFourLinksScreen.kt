...
@Composable
fun AddTwentyFourLinksScreen(context : Context, navController: NavController){
                    ...
                    .clickable {
                        scope.launch {
                            if (titleText.value.isNotBlank() && linkText.value.isNotBlank()) {
                                db
                                    .twentyFourLinksDao()
                                    .insertTwentyFourLinks(
                                        TwentyFourLinks(
                                            title = titleText.value,
                                            link = linkText.value
                                        )
                                    )
                                navController.navigate("TwentyFourScreen/${titleText.value}/\"no_data\"/\"no_data\"")
                            } else {
                                Toast
                                    .makeText(
                                        context,
