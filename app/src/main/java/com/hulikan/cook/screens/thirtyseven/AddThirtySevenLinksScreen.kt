...
@Composable
fun AddThirtySevenLinksScreen(context : Context, navController: NavController){
                    ...
                    .clickable {
                        scope.launch {
                            if (titleText.value.isNotBlank() && linkText.value.isNotBlank()) {
                                db
                                    .thirtySevenLinksDao()
                                    .insertThirtySevenLinks(
                                        ThirtySevenLinks(
                                            title = titleText.value,
                                            link = linkText.value
                                        )
                                    )
                                navController.navigate("ThirtySevenScreen/${titleText.value}/\"no_data\"/\"no_data\"")
                            } else {
                                Toast
                                    .makeText(
                                        context,
