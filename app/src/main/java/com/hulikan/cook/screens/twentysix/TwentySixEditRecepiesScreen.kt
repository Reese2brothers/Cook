...
@Composable
fun TwentySixEditRecepiesScreen(context: Context, navController: NavController, title: String, content: String, image : String){
                        ...
                        Button(colors = ButtonDefaults.buttonColors(
                            ...
                            onClick = {
                                scope.launch {
                                    ...
                                    navController.navigate("TwentySixRecepiesScreen/$updatedTitle/$updatedContent/$updatedImage")
                                }
                                showDialog.value = false
                            }) {
