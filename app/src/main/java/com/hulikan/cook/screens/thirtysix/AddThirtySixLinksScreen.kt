...
@Composable
fun AddThirtySixLinksScreen(context : Context, navController: NavController){
                    ...
                    .clickable {
                        scope.launch {
                            if (titleText.value.isNotBlank() && linkText.value.isNotBlank()) {
                                db
                                    .thirtySixLinksDao()
                                    .insertThirtySixLinks(
                                        ThirtySixLinks(
                                            title = titleText.value,
                                            link = linkText.value
                                        )
                                    )
                                navController.navigate("ThirtySixScreen/${titleText.value}/\"no_data\"/\"no_data\"")
                            } else {
                                Toast
                                    .makeText(
                                        context,
