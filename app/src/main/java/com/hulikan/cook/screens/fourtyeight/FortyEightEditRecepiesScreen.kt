...
@Composable
fun FortyEightEditRecepiesScreen(context: Context, navController: NavController, title: String, content: String, image : String){
                    ...
                    confirmButton = {
                        Button(colors = ButtonDefaults.buttonColors(
                            ...
                            onClick = {
                                scope.launch {
                                    scope.launch {
                                        db.fortyEightDao().updateRecepie(
                                            titleText.value,
                                            contentText.value,
                                            decodedTitle,
                                            decodedImage
                                    ...
                                    navController.navigate("FortyEightRecepiesScreen/$updatedTitle/$updatedContent/$updatedImage")
                                }
                                showDialog.value = false
                            }) {
