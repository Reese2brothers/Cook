...
@Composable
fun NewSeventeenRecepiesScreen(context : Context, navController: NavController){
                        ...
                        modifier = Modifier.size(30.dp).padding(end = 4.dp).clickable {
                            if (titleText.value.isNullOrBlank() && contentText.value.isNullOrBlank()) {
                                ...
                                scope.launch {
                                    ...
                                    db.seventeenDao().insertSeventeen(Seventeen(title = title, content = content, images = images, videos = ""))
                                    ...
                                    navController.navigate("SeventeenScreen/$encodedTitle/$encodedContent/$encodedImageUri")
                                }
                            }
                        },
