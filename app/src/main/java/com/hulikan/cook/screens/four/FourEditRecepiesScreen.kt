...
@Composable
fun FourEditRecepiesScreen(context: Context, navController: NavController, title: String, content: String, image : String){
                        ...
                        Button(colors = ButtonDefaults.buttonColors(
                            ...
                            onClick = {
                                scope.launch {
                                    ...
                                    navController.navigate("FourRecepiesScreen/$updatedTitle/$updatedContent/$updatedImage")
                                }
                                showDialog.value = false
                            }) {
