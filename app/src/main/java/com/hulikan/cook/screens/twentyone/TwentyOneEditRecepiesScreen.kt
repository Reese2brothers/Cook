...
@Composable
fun TwentyOneEditRecepiesScreen(context: Context, navController: NavController, title: String, content: String, image : String){
                        ...
                        Button(colors = ButtonDefaults.buttonColors(
                            ...
                            onClick = {
                                scope.launch {
                                    ...
                                    navController.navigate("TwentyOneRecepiesScreen/$updatedTitle/$updatedContent/$updatedImage")
                                }
                                showDialog.value = false
                            }) {
