...
@Composable
fun ThirtySevenEditRecepiesScreen(context: Context, navController: NavController, title: String, content: String, image : String){
                    ...
                    confirmButton = {
                        Button(colors = ButtonDefaults.buttonColors(
                            ...
                            onClick = {
                                scope.launch {
                                    scope.launch {
                                        db.thirtySevenDao().updateRecepie(
                                            titleText.value,
                                            contentText.value,
                                            decodedTitle,
                                            decodedImage
                                    ...
                                    navController.navigate("ThirtySevenRecepiesScreen/$updatedTitle/$updatedContent/$updatedImage")
                                }
                                showDialog.value = false
                            }) {
