...
@Composable
fun ThirtyNineEditRecepiesScreen(context: Context, navController: NavController, title: String, content: String, image : String){
                    ...
                    confirmButton = {
                        Button(colors = ButtonDefaults.buttonColors(
                            ...
                            onClick = {
                                scope.launch {
                                    scope.launch {
                                        db.thirtyNineDao().updateRecepie(
                                            titleText.value,
                                            contentText.value,
                                            decodedTitle,
                                            decodedImage
                                    ...
                                    navController.navigate("ThirtyNineRecepiesScreen/$updatedTitle/$updatedContent/$updatedImage")
                                }
                                showDialog.value = false
                            }) {
