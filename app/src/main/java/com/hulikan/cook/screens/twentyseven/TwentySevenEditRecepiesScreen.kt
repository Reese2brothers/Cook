...
@Composable
fun TwentySevenEditRecepiesScreen(context: Context, navController: NavController, title: String, content: String, image : String){
                    ...
                    confirmButton = {
                        Button(colors = ButtonDefaults.buttonColors(
                            ...
                            onClick = {
                                scope.launch {
                                    scope.launch {
                                        db.twentySevenDao().updateRecepie(
                                            titleText.value,
                                            contentText.value,
                                            decodedTitle,
                                            decodedImage
                                    ...
                                    navController.navigate("TwentySevenRecepiesScreen/$updatedTitle/$updatedContent/$updatedImage")
                                }
                                showDialog.value = false
                            }) {
